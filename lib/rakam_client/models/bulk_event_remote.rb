...
module RakamClient
  ...
  class BulkEventRemote
    ...
    def valid?
      type_validator = EnumAttributeValidator.new('String', ["AVRO", "CSV", "JSON"])
      return false unless type_validator.valid?(@type)
      compression_validator = EnumAttributeValidator.new('String', ["GZIP"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["AVRO", "CSV", "JSON"])
    ...
    def hash
      [collection, urls, type, compression, options].hash
    end
