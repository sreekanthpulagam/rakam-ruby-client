...
module RakamClient
  ...
  class CreatePrecomputedTable
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'measures')
        if (value = attributes[:'measures']).is_a?(Array)
          self.measures = value
        end
      end
    ...
    def valid?
      ...
      return false if @aggregations.nil?
      return false if @measures.nil?
    ...
    def hash
      [collections, dimensions, aggregations, measures, table_name].hash
    end
