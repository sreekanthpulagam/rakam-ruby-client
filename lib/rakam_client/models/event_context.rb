...
module RakamClient
  ...
  class EventContext
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'upload_time')
    ...
    def valid?
      ...
      return false if @upload_time.nil?
    ...
    def hash
      [api_key, library, api_version, upload_time, checksum, plugins].hash
    end
